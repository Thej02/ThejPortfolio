...
const ToggleButton = ({ onClick, isShowingMore }) => (
  ...
  >
    ...
    <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-pastel-primary/50 transition-all duration-300 group-hover:w-full" />
  </button>
);
...
const keyboardRows = [
  [
    ...
    },
    {
      ...
      description:
        "Class-based, object-oriented language optimized for enterprise-grade backend services.",
    },
    {
      key: "JS",
      label: "JavaScript",
      ...
      description:
        "Dynamic scripting engine utilized for full-stack logic, asynchronous runtime services, and styling.",
    },
    {
      key: "C",
      label: "C Language",
      ...
      description:
        "Low-level structures and compilation foundations for system coding and optimized algorithm blocks.",
    },
    {
      key: "SQL",
      label: "SQL",
      ...
      description:
        "Relational database querying and management standards across MySQL, PostgreSQL, and SQLite.",
    },
    {
      key: "Python",
      label: "Python",
      type: "tech",
      category: "Scripting & AI Integration",
      description:
        "High-level programming platform optimized for scripts, machine learning prompts, and quick web hooks.",
    },
    {
      key: "Git",
      label: "Git",
      ...
      description:
        "Distributed codebase management and change auditing tool built for collaborative software engineering.",
    },
    {
      key: "Linux",
      label: "Linux",
      ...
      description:
        "Unix-based operating system shell administration, scripting utilities, and cloud container hosting.",
    },
    {
      key: "AWS",
      label: "AWS",
      ...
      description:
        "Amazon Web Services environment hosting server instances, storage containers, and virtual compute nodes.",
    },
    {
      key: "S3",
      label: "AWS S3",
      ...
      description:
        "Simple Storage Service containers configured for secure storage of document vaults, logs, and database seeds.",
    },
    {
      key: "EC2",
      label: "AWS EC2",
      ...
      description:
        "Elastic Compute Cloud system virtualizing secure OS instances to deploy live production APIs.",
    },
    {
      key: "DEL",
      label: "Del",
  ...
  [
    ...
    },
    {
      ...
      description:
        "Virtual DOM UI engine for rendering dynamic views and handling frontend states.",
    },
    {
      key: "HTML",
      label: "HTML5",
      ...
      description:
        "Structural markup specifications formatting standard semantic DOM hierarchies.",
    },
    {
      key: "CSS",
      label: "CSS3",
      ...
      category: "Languages & Web",
      description:
        "Styling standards, flexible page layouts, grids, media queries, and transition keys.",
    },
    {
      key: "Node",
      label: "Node.js",
      ...
      description:
        "Asynchronous JavaScript event loops serving concurrent connections on server-side nodes.",
    },
    {
      key: "Express",
      label: "Express",
      ...
      category: "Backend Runtimes",
      description:
        "Minimalist server routing engine running endpoints, middleware, and backend API routes.",
    },
    {
      key: "Mongo",
      label: "MongoDB",
      ...
      category: "Databases & Queries",
      description:
        "Flexible schema storage hosting JSON documents in NoSQL setups.",
    },
    {
      key: "MySQL",
      label: "MySQL",
      ...
      category: "Databases & Queries",
      description:
        "Relational database server orchestrating tables, indices, foreign relations, and atomic commits.",
    },
    {
      key: "REST",
      label: "REST APIs",
      ...
      description:
        "HTTP RESTful conventions designing secure endpoints and communication protocols.",
    },
    {
      key: "Postman",
      label: "Postman",
      ...
      category: "Tools & Collaboration",
      description:
        "Testing desktop framework simulating endpoints, verifying JSON responses, and building APIs.",
    },
    {
      key: "BACK",
      label: "Backspace",
  ...
  [
    ...
    },
    {
      ...
      description:
        "Data Structures and Algorithms parsing computational paths and sorting data efficiently.",
    },
    {
      key: "OOPs",
      label: "OOPs",
      ...
      category: "Computer Science",
      description:
        "Object-Oriented Programming paradigms: Inheritance, Encapsulation, Polymorphism, and Abstraction.",
    },
    {
      key: "DBMS",
      label: "DBMS",
      ...
      category: "Computer Science",
      description:
        "Database management system algorithms, transactions, index caching, and logging schemas.",
    },
    {
      key: "OS",
      label: "OS",
      ...
      category: "Computer Science",
      description:
        "Operating system principles tracking process schedules, threads, page tables, and file maps.",
    },
    {
      key: "Networks",
      ...
      category: "Computer Science",
      description:
        "Networking configurations detailing sockets, TCP/UDP sockets, DNS, and IP stacks.",
    },
    {
      key: "Bash",
      label: "Bash/Shell",
      ...
      category: "Infrastructure",
      description:
        "Shell scripting engines executing task lines and system automation.",
    },
    {
      key: "ENTER",
      label: "Enter",
...
const sortProjects = (projectList) => {
  ...
  return [...projectList].sort((a, b) => {
    const aIndex = PROJECT_ORDER.indexOf(
      a?.Title
    );

    const bIndex = PROJECT_ORDER.indexOf(
      b?.Title
    );

    /*
      If a project is not in our desired list,
      place it after all five projects.
    */

    const aOrder =
      aIndex === -1
        ? PROJECT_ORDER.length
        : aIndex;
...
export default function FullWidthTabs() {
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      /*
        Supabase returned projects.
        Sort them before putting them into state.
      */
  ...
  useEffect(() => {
    try {
      ...
      if (
        ...
        /*
          IMPORTANT:
          Even old cached projects
          are sorted here.
        */

        const orderedCachedProjects =
          sortProjects(
            parsedProjects
          );

        setProjects(
          orderedCachedProjects
        );
      }
    } catch (err) {
      console.warn(
  ...
  /*
    Sort one final time immediately
    before rendering.

    This guarantees that no matter
    where projects came from, the
    cards are displayed in the
    required order.
  */
  ...
  return (
    <div className="w-full bg-transparent overflow-hidden">
      ...
      <div
        className="md:px-[10%] px-[5%] pb-16 pt-16 sm:mt-0 mt-[3rem]"
        id="Skills"
      >
        <div
        ...
        >
          ...
          <p className="text-pastel-muted max-w-2xl mx-auto text-sm md:text-base mt-2">
            ...
            architectural concepts I use to
            engineer backend microservices and
            full-stack software.
          </p>
        </div>
        ...
        <div className="container mx-auto pb-10 text-[#3A3A3A] px-2 sm:px-4 flex flex-col items-center">
          ...
          <p className="text-center text-pastel-muted text-xs md:text-sm mb-6 max-w-lg">
            ...
            Hover over or tap any artisan keycap
            below to inspect my tech stack
            details and software tools.
          </p>
                    ...
                    {row.map(
                      (k, keyIndex) => {
                        ...
                        if (
                          ...
                          keyBg =
                            "bg-[#B8E3D2] border-[#2E6B57]";
                        } else if (
                          k.key ===
                          "ENTER"
                        ) {
                          keyBg =
                            "bg-[#C9B6E4] border-[#7F6B9E]";
                        } else if (
                          !isTech
                        ) {
                          keyBg =
                            "bg-[#EAE5DF] border-[#C3B8AC] text-slate-500";
                        } else {
                          keyBg =
                            "bg-white hover:bg-gradient-to-r hover:from-pastel-primary/10 hover:to-pastel-tertiary/10";
                        }
            ...
            {activeKey ? (
              ...
              <div className="text-center text-pastel-muted py-6 flex flex-col items-center gap-2">
                ...
                <p className="text-sm font-medium">
                  Hover over any keycap on
                  the mechanical keyboard to
                  inspect my tech stack details.
                </p>
      ...
      <div
        className="md:px-[10%] px-[5%] w-full pb-16 pt-16"
        id="Portofolio"
      >
        ...
        >
          ...
          <p className="text-pastel-muted max-w-2xl mx-auto text-sm md:text-base mt-2">
            ...
            applications and software highlights
            that I have designed, engineered, and
            deployed.
          </p>
